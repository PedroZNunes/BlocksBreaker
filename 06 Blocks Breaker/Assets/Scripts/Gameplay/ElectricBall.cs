...
public class ElectricBall : PowerUps {
	...
	[SerializeField] private float effectArea = 1.8f;
	...
	void Awake(){
		...
		Debug.Assert (background != null, "Background not found in electricball powerup");
	...
	protected override void EndOfEffect(){
		StartCoroutine (ChangeBackgroundColor (baseColor));
	}
