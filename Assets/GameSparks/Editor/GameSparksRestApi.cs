...
namespace GameSparks.Editor
{
    ...
    public class GameSparksRestApi
    {
        ...
        private static readonly string HOST = "https://portal.gamesparks.net/";
        private static readonly string HOST2 = "http://repo.gamesparks.net/unity-sdk/";

        private static readonly string REST_URL = HOST + "rest/";
