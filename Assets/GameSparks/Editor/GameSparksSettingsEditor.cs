...
namespace GameSparks.Editor
{
    ...
    {
        readonly GUIContent apiSecretLabel = new GUIContent("Api Secret [?]:", "GameSparks Api Secret can be found at https://portal.gamesparks.net");
        readonly GUIContent apiKeyLabel = new GUIContent("Api Key [?]:", "GameSparks Api Key can be found at https://portal.gamesparks.net");
        readonly GUIContent previewLabel = new GUIContent("Preview Build [?]:", "Run app against the preview service");
        readonly GUIContent debugLabel = new GUIContent("Debug Build [?]:", "Run app with extended debugging");
